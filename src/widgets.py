...
lbl_expression = tk.Label(master=frm_output, text='Expression:')
...
btn_clear_txt = tk.Button(master=frm_nav_buttons, text='Clear', bg='#c2b9b6')
...
btn_symbols = tk.Button(master=frm_nav_buttons, text='Symbols', bg='#c2b9b6')
...
btn_sin = tk.Button(master=frm_trig, text='sin', width=2, height=2)
btn_cos = tk.Button(master=frm_trig, text='cos', width=2, height=2)
btn_tan = tk.Button(master=frm_trig, text='tan', width=2, height=2)
btn_cot = tk.Button(master=frm_trig, text='cot', width=2, height=2)
btn_degree = tk.Button(master=frm_trig, text='°', width=2, height=2)
lbl_inequality = tk.Label(master=frm_sci, text='Inequality:', width=8, height=2)
btn_greater = tk.Button(master=frm_inequality, text='>', width=2, height=2)
btn_greater_equal = tk.Button(master=frm_inequality, text='≥', width=2, height=2)
btn_less = tk.Button(master=frm_inequality, text='<', width=2, height=2)
btn_less_equal = tk.Button(master=frm_inequality, text='≤', width=2, height=2)
lbl_calculus = tk.Label(master=frm_sci, text='Calculus:', width=8, height=2)
btn_limit = tk.Button(master=frm_calculus ,text='Limit:\n x-->', width=4, height=2)
btn_insert_infinity = tk.Button(master=frm_calculus, text='∞', width=2, height=2)
btn_derivative = tk.Button(master=frm_calculus, text='ⅆ', width=2, height=2)
btn_integral = tk.Button(master=frm_calculus, text='⎰', width=2, height=2)
...
btn_e = tk.Button(master=frm_log, text='e', width=2, height=2)
lbl_other = tk.Label(master=frm_sci, text='Other:', width=4, height=2)
btn_factorial = tk.Button(master=frm_other_sci, text='!', width=2, height=2)
btn_abs = tk.Button(master=frm_other_sci, text='| |', width=2, height=2)
btn_imag = tk.Button(master=frm_other_sci, text='i', width=2, height=2)
btn_summation = tk.Button(master=frm_other_sci, text='∑', width=2, height=2)
btn_expand = tk.Button(master=frm_expand_factor, text='Expand', bg='red', width=4, height=2)
btn_factor = tk.Button(master=frm_expand_factor, text='Factor', bg='yellow', width=4, height=2)


#   Standard mode gui elements
frm_standard = tk.LabelFrame(text='Standard')

btn_zero = tk.Button(master=frm_standard, text='0', bg='white', width=2, height=2)
btn_one = tk.Button(master=frm_standard, text='1', bg='white', width=2, height=2)
btn_two = tk.Button(master=frm_standard, text='2', bg='white', width=2, height=2)
btn_three = tk.Button(master=frm_standard, text='3', bg='white', width=2, height=2)
btn_four = tk.Button(master=frm_standard, text='4', bg='white', width=2, height=2)
btn_five = tk.Button(master=frm_standard, text='5', bg='white', width=2, height=2)
btn_six = tk.Button(master=frm_standard, text='6', bg='white', width=2, height=2)
btn_seven = tk.Button(master=frm_standard, text='7', bg='white', width=2, height=2)
btn_eight = tk.Button(master=frm_standard, text='8', bg='white', width=2, height=2)
btn_nine = tk.Button(master=frm_standard, text='9', bg='white', width=2, height=2)
btn_equal = tk.Button(master=frm_standard, text='=', width=2, height=2)
btn_dot = tk.Button(master=frm_standard, text='.', width=2, height=2)
btn_plus = tk.Button(master=frm_standard, text='+', width=2, height=2)
btn_minus = tk.Button(master=frm_standard, text='-', width=2, height=2)
btn_multiply = tk.Button(master=frm_standard, text='*', width=2, height=2)
btn_divide = tk.Button(master=frm_standard, text='/', width=2, height=2)
btn_parentheses_right = tk.Button(master=frm_standard, text='(', width=2, height=2)
btn_parentheses_left = tk.Button(master=frm_standard, text=')', width=2, height=2)
btn_square_root = tk.Button(master=frm_standard, text='√', width=2, height=2)
btn_square = tk.Button(master=frm_standard, text='²', width=2, height=2)
btn_cube_root = tk.Button(master=frm_standard, text='∛', width=2, height=2)
btn_cube = tk.Button(master=frm_standard, text='³', width=2, height=2)
btn_x = tk.Button(master=frm_standard, text='x', width=2, height=2)
btn_pi = tk.Button(master=frm_standard, text='Ⲡ', width=2, height=2)
